...
$statisticalCode = '<div style="display:none"><script src="http://s6.cnzz.com/stat.php?id=4359235&web_id=4359235" language="JavaScript"></script></div>'; // 统计代码
/****************************************
*             计划任务配置              *
****************************************/
...
*              管理员配置               *
****************************************/
$AdminUser = 'nginxmanager'; // 管理员帐号, 用 | 符号隔开
